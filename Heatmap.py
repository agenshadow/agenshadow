...
#1 Je maakt eerst een for loop die van 0 tot de lengte van num_rows gaat
...
# zeggen . Zoals eerder, de ha en va zorgen ervoor dat het centraal staat, al is dit minder belangrijk.
# De size is 15, om het duidelijker in beeld te krijgen.
plt.text(num_cols/2 - 0.6, -0.6, '15m', ha='center', va='center', size="15")
# Hetzelfde als bij degene hierboven, alleen draai ik deze 90 graden, zodat het geldt voor de Lengte.
plt.text(-0.6, num_rows/2 - 0.6, '8m', ha='center', va='center', rotation=90, size="15")

# plt.ylim zorgt ervoor dat ik de x as "Breedte" kan bewegen ten opzichte van de heatmap, waardoor ik het
# beter kan plaatsen onder de 15m
